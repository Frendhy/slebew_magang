...
<div class="max-w-7xl mx-auto pb-12">
    <div class="mb-6">
        <a href="{{ route('admin.search') }}" class="text-slate-500 hover:text-brand-900 flex items-center gap-2 mb-4 transition-colors text-sm">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
            Kembali ke Pencarian SPK
        </a>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-0.5">Assignment yang sudah diatur oleh Foreman untuk SPK ini.</p>
            </div>
        </div>
